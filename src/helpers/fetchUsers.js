...
export const UseFetchAddUser = async (user) => {
    const url = `http://localhost:3002/survivalsro/api/Users/SaveUser?firstName=${user.username}&lastName=${user.lastName}&email=${user.email}&password=${md5.hex(user.pass)}`;
